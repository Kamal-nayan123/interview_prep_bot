...
const Agent = ({userName,userId,type}:AgentProps) => {
    ...
    useEffect(()=>{
        ...
        const onMesaage =(message:Message)=>{
    ...
    const isCallInactiveOrFinish=callStatus===CallStatus.INACTIVE || callStatus===CallStatus.FINISHED;
  return (
    <>
